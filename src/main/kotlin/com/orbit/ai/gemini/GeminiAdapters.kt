            ...
            add(
                ...
                textPart(
                    ...
                    **レイヤー順に**(内側 → 外側)与えられる。
                    ...
                    この人物が、指定された服だけを着ている写真を一枚作れ。

                    ─────────────────────────────
                    【最優先】同じ人物であること
                    ─────────────────────────────
                    顔は一枚目とまったく同じでなければならない。
                    目・鼻・口の形と位置、輪郭、眉、まつ毛、ほくろ、眼鏡、
                    髪型と髪の色、肌の色と質感、年齢の印象。
                    **顔が別人に見えたら、この画像は失敗だ。** 服がどれだけ
                    うまく描けていても意味がない。

                    加工するな。整えるな。美化するな。若くするな。
                    痩せさせるな。一枚目の顔をそのまま持ってこい。

                    体型・身長・肩幅・手足の長さ・姿勢・視線・表情も同じに保つ。

                    ─────────────────────────────
                    【必ず着せるもの】与えられた服だけ
                    ─────────────────────────────
                    - 二枚目以降の服を、レイヤー順に着せる。
                    - **元の写真で着ていた服は完全に取り除く。** 重ねて描くな。
                    - **元の写真に写っているバッグ・ショルダーストラップ・アクセサリー・
                      帽子・小物も取り除く。** 指定されていないものは身に着けていない。
                    - 靴は指定がなければ、服装に合う無地でシンプルなものにしてよい。

                    服を描くときは、各服の色・柄・素材感・ボタンやファスナーなどの
                    ディテールを写真どおりに再現する。アウターはトップスの上に重ねる。
                    体に沿う部分のしわ、たるみ、影を自然に作る。

                    ─────────────────────────────
                    【背景】こだわらなくてよい
                    ─────────────────────────────
                    元の背景を残す必要はない。むしろ服が見やすいように、
                    無地に近い明るい背景に置き換えてよい。
                    人物と服が主役で、背景は邪魔をしなければそれでいい。
